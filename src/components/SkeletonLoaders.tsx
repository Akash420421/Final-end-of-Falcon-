...
export const FullPageSkeletonLoader: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#0E0F1D] text-white flex flex-col w-full overflow-hidden animate-pulse">
      {/* 1. Header Skeleton */}
      <div className="bg-[#121324] border-b border-slate-800 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-slate-800 rounded-xl"></div>
          <div>
            <div className="w-28 h-4 bg-slate-800 rounded"></div>
            <div className="w-20 h-2.5 bg-slate-800/60 rounded mt-1"></div>
          </div>
        </div>
      ...
      <div className="bg-[#18192E] border-b border-slate-800/80 px-4 py-2.5 flex items-center gap-4">
      ...
      {/* 7. Footer Status Bar */}
      <div className="bg-[#121324] border-t border-slate-800 py-3 text-center text-xs text-slate-500 flex items-center justify-center gap-2">
        <div className="w-2 h-2 rounded-full bg-amber-500 animate-ping"></div>
        <span>Connecting to Falcon Electrics Database...</span>
      </div>
    </div>
  );
};
